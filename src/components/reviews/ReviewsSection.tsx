...
const INITIAL_REVIEWS: Review[] = [
  ...
  },
  {
    ...
    timeAgo: "1 week ago",
    comment:
      "Our central 4-ton inverter system kept tripping the clinic breaker. Another contractor insisted on a complete outdoor unit replacement. MT Enterprise diagnosed a shorted IPM module on the inverter PCB board and repaired the circuit board directly on-site at a fraction of the cost. Completely honest and technically brilliant.",
    avatarBg: "bg-[#ea580c]",
    initials: "FQ",
  },
  {
  ...
  },
  {
    ...
    timeAgo: "1 month ago",
    comment:
      "Deep chemical descaling on two split AC units. Blower wheels were dismantled and fully disinfected. Measured the suction gas pressure with digital gauges to verify cooling specs. Clean, transparent work.",
      ...
      <div className="w-full max-w-[1600px] mx-auto">
        ...
        <div className="mb-20">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 pb-8">
            ...
            >
              Audited feedback from commercial plants, facility directors, and appliance owners. Real customer diagnostics with zero fabricated ratings.
            </motion.p>
          </div>
        ...
        <div className="mb-20 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          {/* Middle: Live Dynamic Progress Lines (Grow on Mount & On Review) */}
        ...
        {/* ================= CLEAN REVIEWS GRID (NO HEAVY BORDERS) ================= */}
