      ...
      <div className="w-full max-w-[1600px] mx-auto">
        ...
        <div className="mb-20">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 pb-8">
            ...
            >
              Engineered troubleshooting and repairs for industrial chillers, commercial cold rooms, refrigeration, and laundry appliances. Every job is restored to factory standard.
            </motion.p>
          </div>
        ...
        {/* ================= 3-COLUMN QUICK SERVICE OVERVIEW BAR ================= */}
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* IMAGE COLUMN: 1 Full photo on Mobile, 2 on Desktop */}
                  <motion.div
                    initial={{ opacity: 0, x: isEven ? -80 : 80 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    viewport={{ once: true, margin: "-100px" }}
                  ...
                  >
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 h-[240px] sm:h-[320px] md:h-[380px] lg:h-[440px] xl:h-[480px]">
                      ...
                      {/* Image 2: HIDDEN on mobile (hidden lg:block), 5 cols on desktop */}
